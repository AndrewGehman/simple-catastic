<?php get_header(); ?>
	...
	<?php if ( is_front_page() && $paged < 2) { ( ! dynamic_sidebar( 'intro-widget-1' ) );
         ...
         <section class="blog-section group"> 
          ...
          <div class="next-prev group">
            <div>
            	...
            	<span class="prev-posts"><?php previous_posts_link( '« Newer Posts', 10) ; ?></span>
                <span class="older-posts"><?php next_posts_link( 'Older Posts »', 10 ); ?></span>
            </div>
 		</div>
